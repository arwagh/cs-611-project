...
void driver(string inFile)
{
    ...
    vector<string> zeroData, oneData, twoData, threeData, fourData, fiveData, sixData, sevenData, eightData, nineData, tenData,
    ...
    // move 0
    int loopSize = zeroData.size();

    for (size_t i = 0; i < loopSize; i++)
    {
        int asciiValue = int(zeroData[i][0]);
    ...
    // move 1
    loopSize = oneData.size();

    for (size_t i = 0; i < loopSize; i++)
    {
        int asciiValue = int(oneData[i][0]);
        int indexValue = asciiTwo[asciiValue];
    ...
    // move 2
    loopSize = twoData.size();

    for (size_t i = 0; i < loopSize; i++)
    {
        int asciiValue = int(twoData[i][0]);
        int indexValue = asciiTwo[asciiValue];
    ...
    // move 3
    loopSize = threeData.size();

    for (size_t i = 0; i < loopSize; i++)
    {
        int asciiValue = int(threeData[i][0]);
        int indexValue = asciiTwo[asciiValue];
    ...
    // move 4
    loopSize = fourData.size();

    for (size_t i = 0; i < loopSize; i++)
    {
        int asciiValue = int(fourData[i][0]);
        int indexValue = asciiTwo[asciiValue];
    ...
    // move 5
    loopSize = fiveData.size();

    for (size_t i = 0; i < loopSize; i++)
    {
        int asciiValue = int(fiveData[i][0]);
        int indexValue = asciiTwo[asciiValue];
    ...
    // move 6
    loopSize = sixData.size();

    for (size_t i = 0; i < loopSize; i++)
    {
        int asciiValue = int(sixData[i][0]);
        int indexValue = asciiTwo[asciiValue];
    ...
    // move 7
    loopSize = sevenData.size();

    for (size_t i = 0; i < loopSize; i++)
    {
        int asciiValue = int(sevenData[i][0]);
        int indexValue = asciiTwo[asciiValue];
    ...
    // move 8
    loopSize = eightData.size();

    for (size_t i = 0; i < loopSize; i++)
    {
        int asciiValue = int(eightData[i][0]);
        int indexValue = asciiTwo[asciiValue];
    ...
    // move 9
    loopSize = nineData.size();

    for (size_t i = 0; i < loopSize; i++)
    {
        int asciiValue = int(nineData[i][0]);
        int indexValue = asciiTwo[asciiValue];
